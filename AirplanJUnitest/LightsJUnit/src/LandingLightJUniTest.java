...
public class LandingLightJUniTest {
	private LandingLight NManufacturer,NType,NId;
	 String manufacturer=" Boeing";
	 String type ="Einstahlig";
	 String id ="234f";
    private boolean isOn;
    LandingLight test= new LandingLight(manufacturer,type,id,isOn);
  @Test
  ...
  public void setUp() throws Exception{
 	 ...
 	 NManufacturer = new LandingLight("Airbus",null,null,false);
 	 NType = new  LandingLight(null,"Zweistahlig",null,false);
 	 NId = new LandingLight(null,null,"09825h",false);
 	 test.on();
